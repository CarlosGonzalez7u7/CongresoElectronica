...
try {
    ...
    foreach ($teams as $team) {
        ...
        $resultTeams[] = [
            ...
            'number_of_robots' => count($teamRobots) > 0 ? count($teamRobots) : (int)($team['number_of_robots'] ?? 0),
            'approved_robots_count' => count($teamRobots) > 0 ? count($teamRobots) : (int)($team['approved_robots_count'] ?? 0),
